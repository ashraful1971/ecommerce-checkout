...
<body>
    <div class="max-w-[1200px] mx-auto my-20">
        ...
        <div class="min-w-[480px] bg-white shadow rounded-md p-4 flex flex-col items-center gap-4">
            <h1 class="text-2xl text-gray-700 font-bold">Success!</h1>
            <p class="text-gray-500">Your payment has been successfull!.</p>
            <a href="/" class="hover:underline hover:underline-offset-4 hover:text-green-700">Go back home</a>
        </div>
    </div>
</body>
</html>